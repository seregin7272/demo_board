                ...
                <div class="form-group">
                  ...
                  {{--   old('address', $region->getAddress()) --}}
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <span class="btn btn-primary btn-block location-button" data-target="#address"><span class="fa fa-location-arrow">Location</span></span>
                        </div>
                    </div>
                    @if ($errors->has('address'))
                        <span class="invalid-feedback"><strong>{{ $errors->first('address') }}</strong></span>
