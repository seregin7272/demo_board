...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.pages.update', $page) }}">
        ...
        <div class="form-group">
            ...
            <textarea id="content" class="summernote form-control{{ $errors->has('content') ? ' is-invalid' : '' }}" data-image-url="{{ route('admin.ajax.upload.image') }}"  name="content" rows="10" required>{{ old('content', $page->content) }}</textarea>
